...
train a relatively better model (Figure 1(a)). Some other factors that may have contributed to this difference include the model architecture, optimisation techniques used and the quality of the dataset.}
}
